...
$scope.choreTurn = () => {
  ...
  let choreTurnToast = `<span><h5>${houseMem1Name} has ${houseMem1PointstoDate} points. ${houseMem2Name} has ${houseMem2PointstoDate} points. Looks like you're both screwed.</h5></span>`
  Materialize.toast(choreTurnToast, 2500)
}
